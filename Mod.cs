...
using p4g64.patch.jyokyohelp.Template;
using Reloaded.Hooks.Definitions;
using Reloaded.Hooks.ReloadedII.Interfaces;
using Reloaded.Mod.Interfaces;
using IReloadedHooks = Reloaded.Hooks.ReloadedII.Interfaces.IReloadedHooks;
using static p4g64.patch.jyokyohelp.Utils;
...
namespace p4g64.patch.jyokyohelp
{
    ...
    public class Mod : ModBase // <= Do not Remove.
    {
        ...
        private delegate int GetJyokyoHelpMessageNo_FindDelegate(nint a1, int skillID);
        ...
        public Mod(ModContext context)
        {
            ...
            SigScan("48 89 74 24 ?? 57 41 54 41 55 41 56 41 57 48 83 EC 20 4C 8B F9 48 63 FA", "GetJyokyoHelpMessageNo", address =>
            {
        ...
        public int GetCustomDatJyokyoHelpMessage(nint a1, int skillID)
        {
            int result = _getDatJyokyoHelpMsgNoHook.OriginalFunction(a1, skillID);
